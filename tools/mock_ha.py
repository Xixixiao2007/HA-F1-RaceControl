...
SCENARIOS = {
    "race_start": {
        "desc": "起跑 → 一堆赛道限制噪音 → 格子旗",
        "interval": 2.0,
        "steps": [
            {"message": "GREEN LIGHT - PIT EXIT OPEN", "flag": "GREEN", "category": "Flag",
             "scope": "Track"},
            {"message": "TRACK LIMITS AT TURN 4", "flag": "", "category": "Other"},
            {"message": "TRACK LIMITS AT TURN 9", "flag": "", "category": "Other"},
            {"message": "CAR 16 TIME DELETED - TRACK LIMITS", "flag": "", "category": "Other"},
            {"message": "TRACK LIMITS AT TURN 1", "flag": "", "category": "Other"},
            {"message": "CAR 4 TIME DELETED - TRACK LIMITS", "flag": "", "category": "Other"},
            {"message": "TRACK LIMITS AT TURN 10", "flag": "", "category": "Other"},
            {"message": "CAR 63 TIME DELETED - TRACK LIMITS", "flag": "", "category": "Other"},
            {"message": "CHEQUERED FLAG", "flag": "CHEQUERED", "category": "Flag",
             "scope": "Track"},
        ],
    },
    "red_flag": {
        "desc": "单黄 → 双黄扩散 4/5/6 → 红旗 → 赛道清空",
        "interval": 2.0,
        "steps": [
            {"message": "YELLOW IN TRACK SECTOR 5", "flag": "YELLOW", "category": "Flag",
             "scope": "Sector", "sector": "5"},
            {"message": "DOUBLE YELLOW IN TRACK SECTOR 4", "flag": "DOUBLE YELLOW",
             "category": "Flag", "scope": "Sector", "sector": "4"},
            {"message": "DOUBLE YELLOW IN TRACK SECTOR 5", "flag": "DOUBLE YELLOW",
             "category": "Flag", "scope": "Sector", "sector": "5"},
            {"message": "DOUBLE YELLOW IN TRACK SECTOR 6", "flag": "DOUBLE YELLOW",
             "category": "Flag", "scope": "Sector", "sector": "6"},
            {"message": "RED FLAG", "flag": "RED", "category": "Flag", "scope": "Track"},
            {"message": "TRACK CLEAR", "flag": "CLEAR", "category": "Flag", "scope": "Track"},
        ],
    },
    "safety_car": {
        ...
        "interval": 2.0,
        "steps": [
            {"message": "YELLOW IN TRACK SECTOR 3", "flag": "YELLOW", "category": "Flag",
             "scope": "Sector", "sector": "3"},
            {"message": "SAFETY CAR DEPLOYED", "flag": "", "category": "SafetyCar"},
            {"message": "SAFETY CAR IN THIS LAP", "flag": "", "category": "SafetyCar"},
            {"message": "TRACK CLEAR", "flag": "CLEAR", "category": "Flag", "scope": "Track"},
        ],
    },
    "vsc": {
        "desc": "黄旗 → VSC 出动 → VSC 结束中 → 赛道清空",
        "interval": 2.0,
        "steps": [
            {"message": "YELLOW IN TRACK SECTOR 2", "flag": "YELLOW", "category": "Flag",
             "scope": "Sector", "sector": "2"},
            {"message": "VSC DEPLOYED", "flag": "", "category": "SafetyCar"},
            {"message": "VSC ENDING", "flag": "", "category": "SafetyCar"},
            {"message": "TRACK CLEAR", "flag": "CLEAR", "category": "Flag", "scope": "Track"},
        ],
    },
    "test_double_yellow": {
        "desc": "双黄扇区 12 → 3 秒后 CLEAR（模拟测试型短命双黄）",
        "steps": [
            {"message": "DOUBLE YELLOW IN TRACK SECTOR 12", "flag": "DOUBLE YELLOW",
             "category": "Flag", "scope": "Sector", "sector": "12"},
            {"delay": 3.0, "message": "CLEAR IN TRACK SECTOR 12", "flag": "CLEAR",
             "category": "Flag", "scope": "Sector", "sector": "12"},
        ],
    },
    "burst": {
        "desc": "同一秒内 7 条（复现实测峰值 7 条/秒），测突发丢号/UI 抖动",
        "interval": 0.0,
        "steps": [
            {"message": "TRACK LIMITS AT TURN 1", "flag": "", "category": "Other"},
            {"message": "TRACK LIMITS AT TURN 2", "flag": "", "category": "Other"},
            {"message": "TRACK LIMITS AT TURN 3", "flag": "", "category": "Other"},
            {"message": "TRACK LIMITS AT TURN 4", "flag": "", "category": "Other"},
            {"message": "TRACK LIMITS AT TURN 5", "flag": "", "category": "Other"},
            {"message": "TRACK LIMITS AT TURN 6", "flag": "", "category": "Other"},
            {"message": "TRACK LIMITS AT TURN 7", "flag": "", "category": "Other"},
        ],
    },
}
